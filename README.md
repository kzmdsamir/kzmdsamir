...
## Applied AI & Local Systems Architecture

My primary focus today is applied AI and local-first systems architecture. I specialize in engineering private, deterministic AI workflows that eliminate reliance on fragile cloud dependencies. My local AI stack leverages containerized setups, Agent Zero, LM Studio APIs, n8n, Supabase, and custom FastAPI middleware to build resilient, local-first automation pipelines.

### Tech Stack & Tooling
* **Languages & Runtimes:** Python, FastAPI, Node.js, Bash
* **Infrastructure & DB:** Docker, Linux, PostgreSQL, Supabase
* **AI Orchestration & Automation:** Agent Zero, LM Studio API, n8n, Google AI Studio / Gemini API

---

## Philosophy

The unifying pattern across my work is simple: **Systems > Motivation** and **Execution > Consumption**. 

I am interested in solving the deployment problem—building practical, reproducible systems grounded in evidence and performance metrics, designed to function reliably in environments where accuracy and uptime matter.
